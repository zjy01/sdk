...
$(function () {
    var index = {
        ...
        init: function () {
            this.item_tlp = '<a class="activity-item" href="http://sdk.mygdufs.com/index.php/Wechat/Index/activity/id/{{id}}.html">' +
        ...
        getMsg: function () {
            ...
            $.ajax({
                //url: 'json/index.json',
                url: 'http://' + location.host + '/index.php/Wechat/Index/getActivityList',
                type: 'get',
                data:{
                    from: self.start,
                    cnt: self.row,
